...
# define ABORT                         RTPANIC("ABORT within RtAllocator")
...
# define MMAP_MM(mm, s)               Rt_AllocatorMap((RtAllocator *) mm, s, MMAP_PROT|MMAP_FLAGS)
# define DIRECT_MMAP_MM(mm, s)        Rt_AllocatorMap((RtAllocator *) mm, s, MMAP_PROT|MMAP_FLAGS)
# define MUNMAP_MM(mm, a, s)          Rt_AllocatorUnmap((RtAllocator *) mm, a, s)

/* # define MREMAP(a, o, n, m)        RtAllocatorRemap(a, o, n, m) */

/**** Options end here ****/

# define memcpy(dest, src, len)       RtMemCopy(dest, src, len)
# define memset(buf, value, size)     RtMemSet(buf, value, size)
