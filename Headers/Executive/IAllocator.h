 ...
 * IAllocator.idl
 *   Defines the standard memory allocator interface
 */
...
#if defined(INITGUID) || !defined(IALLOCATOR_H_GUIDS_DEFINED_)
# define IALLOCATOR_H_GUIDS_DEFINED_
...
#endif /*INITGUID || !IALLOCATOR_H_GUIDS_DEFINED_ */
